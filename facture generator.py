import sys
import pandas as pd
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QListWidget, QStackedLayout, QComboBox, QMessageBox
    ...
    def add_product(self):
        ...
        if product_name and product_quantity and product_price:
            ...
            self.product_list.addItem(
                f"名{product_name} - 量{product_quantity} - 单价{product['Prix unitaire']:.2f} - 总{product['Prix total']:.2f}")
