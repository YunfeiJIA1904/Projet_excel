...
#--------------------------------------------------clients Functions--------------------------------------------------
    ...
    def save_client_if_not_exists(self, client_info):
        # Load existing clients from the JSON file
        try:
            with open('clients.json', 'r') as file:
        ...
        # Normalize the names to lowercase for comparison
        ...
        if new_client_name in client_names:
            ...
            # Mapping of French keys to Chinese keys
            key_mapping = {
                "Adresse": "地址",
                "Adresse_cp": "邮政编码",
                "Adresse_ville": "城市",
